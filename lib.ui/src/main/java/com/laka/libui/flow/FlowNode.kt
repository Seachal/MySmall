...
class FlowNode : TextView {
    ...
    @ColorInt
    private var mBgColor: Int = ContextCompat.getColor(context, R.color.white)
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        attrs?.let {
            ...
            mBgColor = typeArray.getColor(R.styleable.FlowNode_bgColor, ContextCompat.getColor(context, R.color.white))
