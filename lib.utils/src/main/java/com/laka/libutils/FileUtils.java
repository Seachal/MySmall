...
import com.laka.libutils.listener.IPermissionQuestCallback;
...
public final class FileUtils {
     ...
     */
    public static File getSDCardDir(String dirPath, boolean isCreate, IPermissionQuestCallback callback) {
     ...
     */
    public File getSDCardFile(String dirPath, boolean isCreate, IPermissionQuestCallback callback) {
        if (StringUtils.isTrimEmpty(dirPath) || !isSDCardMounted()) {
            return null;
        }
        if (!checkReadAndWritePermission()) {
     ...
     */
    public static int deleteSDCardFile(String filePath, IPermissionQuestCallback callback) {
     ...
     * @return true ，存在；false ，不存在
     */
    public static boolean isSDCardFileExit(String filePath, boolean isFile, IPermissionQuestCallback callback) {
        if (StringUtils.isTrimEmpty(filePath)) {
            return false;
        }
        if (checkReadAndWritePermission()) {
